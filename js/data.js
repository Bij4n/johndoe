...
var CITIES_BY_STATE = {
    'AL': { cities: ['Birmingham', 'Montgomery', 'Huntsville', 'Mobile', 'Tuscaloosa'], zipStart: '350' },
    'AK': { cities: ['Anchorage', 'Fairbanks', 'Juneau', 'Sitka'], zipStart: '995' },
    ...
    'DE': { cities: ['Wilmington', 'Dover', 'Newark', 'Middletown'], zipStart: '197' },
    'FL': { cities: ['Miami', 'Orlando', 'Tampa', 'Jacksonville', 'Fort Lauderdale', 'St. Petersburg'], zipStart: '321' },
    ...
    'IN': { cities: ['Indianapolis', 'Fort Wayne', 'Evansville', 'South Bend', 'Carmel'], zipStart: '462' },
    ...
    'NY': { cities: ['New York', 'Buffalo', 'Rochester', 'Albany', 'Syracuse', 'Yonkers'], zipStart: '100' },
    ...
    'TX': { cities: ['Houston', 'Dallas', 'Austin', 'San Antonio', 'Fort Worth', 'El Paso', 'Arlington', 'Plano'], zipStart: '750' },
